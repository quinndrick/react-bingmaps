...
class ReactBingmaps extends Component {
  ...
  componentWillReceiveProps(nextProps) {
    ...
    if (this.props.heatMap !== nextProps.heatMap) {
      this.setHeatMap(nextProps.heatMap, mapReference);
    }
  }
  reactBingmaps(props, Microsoft) {
    ...
    if (bingmapKey && Microsoft) {
      ...
      this.setHeatMap(heatMap, mapReference);
    }
  }
  ...
  setHeatMap(heatMap, mapReference) {
    // console.log(heatMap);
    console.log(map[mapReference]);
    // console.log(map);
    ...
    if (map[mapReference] && heatMap) {
      console.log("if working");

      for (var i = map[mapReference].entities.getLength() - 1; i >= 0; i--) {
        var heatMap = map[mapReference].entities.get(i);
        if (heatMap instanceof Microsoft.Maps.HeatMap) {
          map[mapReference].entities.removeAt(i);
        }
      }
      ...
      for (let i = 0; i < 10; i++) {
        const long = Math.random() - 34;
        const lat = Math.random() + 151;
      ...
      Microsoft.Maps.loadModule("Microsoft.Maps.HeatMap", function() {
        let heatmap = new Microsoft.Maps.HeatMapLayer(map[mapReference], [], {
          intensity: 0.65,
          radius: 100000,
          unit: "meters",
          colorgradient: {

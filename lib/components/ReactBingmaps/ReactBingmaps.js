  ...
  _createClass(ReactBingmaps, [
    ...
    },
    {
      ...
      value: function componentWillReceiveProps(nextProps) {
        ...
        if (this.props.heatMapLocations !== nextProps.heatMapLocations) {
          this.setHeatMap(nextProps.heatMapLocations, mapReference);
        }
      }
    },
    {
      ...
      value: function reactBingmaps(props, Microsoft) {
        var bingmapKey = props.bingmapKey,
          ...
          heatMapLocations = props.heatMapLocations;
        ...
        if (bingmapKey && Microsoft) {
          ...
          this.setHeatMap(heatMapLocations, mapReference);
        }
      }
    },
    {
            ...
            for (
              ...
              if (infoboxesWithPushPins[infoboxWithPushPinIndex].location) {
                ...
                if (infoboxOption.htmlContent) {
                  infoboxOption.htmlContent = _server2.default.renderToStaticMarkup(
    ...
    {
      key: "setHeatMap",
      value: function createHeatMap(heatMapLocations, mapReference) {
        console.log("begin heat map creation");
      }
    },
    {
      key: "setBoundary",
...
ReactBingmaps.propTypes = {
  ...
  heatMapLocations: _propTypes2.default.arrayOf(_propTypes2.default.object)
};
